...
CREATE TABLE `payment` (
  ...
  `isTaxBill` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `totalBillAmount` int DEFAULT NULL,
  `discount` int DEFAULT '0',
  `paymentRefNo` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `totalAmount` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Payment_partyId_fkey` (`partyId`),
  KEY `Payment_branchId_fkey` (`branchId`),
  KEY `Payment_createdById_fkey` (`createdById`),
  KEY `Payment_updatedById_fkey` (`updatedById`),
...
-- Dump completed on 2026-04-11 13:05:40
