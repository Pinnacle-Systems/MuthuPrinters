...
CREATE TABLE `state` (
  ...
  PRIMARY KEY (`id`),
  KEY `State_countryId_fkey` (`countryId`),
...
INSERT INTO `state` VALUES (1,'TAMILNADU','1','33',1,1),(16,'KERALA','KL','',1,1),(19,'KARNATAKA','KA','',1,1);
...
-- Dump completed on 2026-04-11 13:06:52
