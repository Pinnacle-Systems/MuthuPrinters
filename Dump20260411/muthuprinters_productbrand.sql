...
CREATE TABLE `productbrand` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ProductBrand_name_key` (`name`),
  KEY `ProductBrand_companyId_fkey` (`companyId`),
  CONSTRAINT `ProductBrand_companyId_fkey` FOREIGN KEY (`companyId`) REFERENCES `company` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2026-04-11 13:06:36
