...
CREATE TABLE `termsandconditions` (
  ...
  PRIMARY KEY (`id`),
  KEY `TermsAndConditions_companyId_fkey` (`companyId`),
  CONSTRAINT `TermsAndConditions_companyId_fkey` FOREIGN KEY (`companyId`) REFERENCES `company` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `termsandconditions` VALUES (5,'As Per Standarts','DEFAULT',1,1);
...
-- Dump completed on 2026-04-11 13:06:42
