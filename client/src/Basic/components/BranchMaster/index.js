...
export default function BranchMaster({ companyCode, setBranchForm }) {
  ...
  const data = {
    ...
    code: codeBranch,
    active: activeBranch,
    contactEmail: contactEmailBranch,
    contactMobile: contactMobileBranch,
    contactName: contactNameBranch,
    companyId,
    id,
    address,
  };
              ...
              <fieldset className="my-1 row-span-2 overflow-auto">
                ...
                <div className="grid grid-cols-1 my-2">
                  <TextInput
                    name="Name"
                    type="text"
                    value={contactNameBranch}
                    setValue={setContactNameBranch}
                    required={true}
                    readOnly={readOnly}
                    disabled={childRecord.current > 0}
                  />
                  <TextInput
                    name="Mobile No"
                    type="number"
                    value={contactMobileBranch}
                    setValue={setContactMobileBranch}
                    required={true}
                    readOnly={readOnly}
                    disabled={childRecord.current > 0}
                  />
                  <TextInput
                    name="Email id"
                    type="text"
                    value={contactEmailBranch}
                    setValue={setContactEmailBranch}
                    required={true}
                    readOnly={readOnly}
                    disabled={childRecord.current > 0}
                  />
