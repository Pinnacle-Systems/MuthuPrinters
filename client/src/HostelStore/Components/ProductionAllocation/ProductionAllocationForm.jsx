    ...
    const handleSave = async (pendingAction = null) => {
        ...
        try {
            ...
            if (id) {
                ...
                Swal.fire({
                    title: "Success", text: "Production Allocation updated successfully", icon: "success", timer: 1500, showConfirmButton: false, didClose: () => {
                        customerRef.current.focus();
                    }
                });
                ...
                setId(savedId);
                Swal.fire({
                    title: "Success", text: "Production Allocation created successfully", icon: "success", timer: 1500, showConfirmButton: false, didClose: () => {
                        customerRef.current.focus();
                    }
                });
            }
